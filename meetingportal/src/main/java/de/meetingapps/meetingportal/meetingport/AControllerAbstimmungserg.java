...
@Named
@Deprecated
public class AControllerAbstimmungserg {

    private @Inject AControllerAbstimmungsergSession aControllerAbstimmungsergSession;
    ...
    public void init() {
        ...
        if (eclParamM.getLfdHVAbstimmungsergIstMoeglich() == 1) {
            for (int i = 1; i <= eclParamM.getParam().paramPortal.abstimmungsergLetzteNr; i++) {
                ...
                if (eclParamM.getParam().paramPortal.abstimmungsergLetzteNr == 1) {
                    lAbstTeilButtonM.setButtontext1Vorne("Abstimmungsergebnis");
                    lAbstTeilButtonM.setDateiname1("Abstimmungserg" + Integer.toString(i));
                } else {
                    lAbstTeilButtonM.setButtontext1Vorne("Abstimmungsergebnis " + Integer.toString(i));
                    lAbstTeilButtonM.setDateiname1("Abstimmungserg" + Integer.toString(i));
                }
        ...
        aControllerAbstimmungsergSession.setAbsTeilButtonList(absTeilButtonList);
    ...
    public String doZurueck() {
        if (!aFunktionen.pruefeStart("aAbstimmungserg")) {
            return "aDlgFehler";
        }
        eclDbM.openAll();
    ...
    public String doRefresh() {
        ...
        init();
        return aFunktionen.setzeEnde("aAbstimmungserg", true, true);
    }
