...
public class  DbVeranstaltungenElementDetail extends DbRoot<EclVeranstaltungenElementDetail> {

//    private int logDrucken=10;
    
    public DbVeranstaltungenElementDetail(DbBundle pDbBundle) {
        super(pDbBundle);
    }
    ...
    String getCreateString() {
        ...
        String createString = "CREATE TABLE " + getSchema() + getTableName()+" ( "
                ...
                + "`textExtern` varchar(500) NOT NULL DEFAULT '', " 
                + "`textIntern` varchar(100) NOT NULL DEFAULT '', " 
                + "`erzeugtWert` char(5) NOT NULL DEFAULT '', " 
                + "`textQuittung` varchar(1000) NOT NULL DEFAULT '', " 
               + "PRIMARY KEY (`identDetail`) " + ") ";
        //      @formatter:on
        return createString;
    }
    ...
    @Override
    String getTableName() {
         return "tbl_veranstaltungenElementDetail";
    }
    ...
    @Override
    EclVeranstaltungenElementDetail decodeErgebnis(ResultSet pErgebnis) {
        EclVeranstaltungenElementDetail lEclReturn = new EclVeranstaltungenElementDetail();
        ...
        try {
            ...
            lEclReturn.erzeugtWert = pErgebnis.getString("erzeugtWert");

             lEclReturn.textQuittung = pErgebnis.getString("textQuittung");
    ...
    @Override
    void fuellePreparedStatementKomplett(PreparedStatement pPStm, int pOffset, EclVeranstaltungenElementDetail pEcl) {
...
//          @formatter:off
            ...
            pPStm.setString(pOffset, pEcl.erzeugtWert);pOffset++;

            pPStm.setString(pOffset, pEcl.textQuittung);pOffset++;
...
//  @formatter:off
    private final String[] felder= {"identDetail", 
            "gehoertZuElement", "position",
            "textExtern", "textIntern", "erzeugtWert",
            "textQuittung", 
            }; 
//  @formatter:on
    ...
    @Override
    public int insert(EclVeranstaltungenElementDetail pEcl) {
        initFelder();
     ...
     public int readAll() {
        ...
        try {
            String lSql = "SELECT * from " + getSchema() + getTableName()+" "
                    + "ORDER BY gehoertZuElement, position";
...
//     * 
//     */
//    public int update(EclVeranstaltungenElementDetail pEcl) {
//        int ergebnis=0;
//        initFelder();
//
//        try {
