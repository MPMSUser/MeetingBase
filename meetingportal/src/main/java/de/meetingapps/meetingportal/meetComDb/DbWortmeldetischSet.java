...
import de.meetingapps.meetingportal.meetComEntities.EclWortmeldetischSet;

/**Hinweis: rueckfragen wird wie fragen behandelt*/

public class  DbWortmeldetischSet extends DbRoot<EclWortmeldetischSet> {

//    private int logDrucken=10;
    
    public DbWortmeldetischSet(DbBundle pDbBundle) {
        super(pDbBundle);
    }
...
//      @formatter:on
    ...
    @Override
    EclWortmeldetischSet decodeErgebnis(ResultSet pErgebnis) {
        EclWortmeldetischSet lEclReturn = new EclWortmeldetischSet();

        try {
            lEclReturn.setIdent = pErgebnis.getInt("setIdent");
    ...
    @Override
    void fuellePreparedStatementKomplett(PreparedStatement pPStm, int pOffset, EclWortmeldetischSet pEcl) {
        int startOffset = pOffset; /*Nur erforderlich zum Überprüfen von Programmierfehlern - Feldanzahl*/

        try {
//          @formatter:off
            
            pPStm.setInt(pOffset, pEcl.setIdent);pOffset++;
...
//          @formatter:on
    ...
    private final String[] felder= {"setIdent", "kurzBeschreibung", "langBeschreibung"}; 
    ...
    @Override
    public int insert(EclWortmeldetischSet pEcl) {
        initFelder();
     ...
     * 
     */
    public int update(EclWortmeldetischSet pEcl) {
        int ergebnis=0;
        initFelder();
