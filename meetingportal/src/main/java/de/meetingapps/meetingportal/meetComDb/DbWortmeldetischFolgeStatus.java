...
public class  DbWortmeldetischFolgeStatus extends DbRoot<EclWortmeldetischFolgeStatus> {

//    private int logDrucken=10;
    
    public DbWortmeldetischFolgeStatus(DbBundle pDbBundle) {
        super(pDbBundle);
    }
    ...
    String getCreateString() {
        ...
        String createString = "CREATE TABLE " + getSchema() + getTableName()+" ( "
                ...
                + "`buttonBezeichnung` varchar(80) NOT NULL DEFAULT '', " 
                + "`buttonJeRaum` int NOT NULL DEFAULT 0, " 
                + "`positionInButtonListe` int NOT NULL DEFAULT 0, " 
               + "PRIMARY KEY (`setNr`, `viewBezeichnung`, `ursprungsStatusBezeichnung`, `folgeStatusBezeichnung`) " + ") ";
        //      @formatter:on
        return createString;
    }
    ...
    @Override
    String getTableName() {
         return "tbl_wortmeldetischFolgeStatus";
    }
    ...
    @Override
    EclWortmeldetischFolgeStatus decodeErgebnis(ResultSet pErgebnis) {
        EclWortmeldetischFolgeStatus lEclReturn = new EclWortmeldetischFolgeStatus();
        ...
        try {
            ...
            lEclReturn.buttonJeRaum = pErgebnis.getInt("buttonJeRaum");
            lEclReturn.positionInButtonListe = pErgebnis.getInt("positionInButtonListe");
    ...
    @Override
    void fuellePreparedStatementKomplett(PreparedStatement pPStm, int pOffset, EclWortmeldetischFolgeStatus pEcl) {
...
//          @formatter:off
            ...
            pPStm.setInt(pOffset, pEcl.buttonJeRaum);pOffset++;
            pPStm.setInt(pOffset, pEcl.positionInButtonListe);pOffset++;
...
//  @formatter:off
    private final String[] felder= {"setNr", 
            "viewBezeichnung", "ursprungsStatusBezeichnung", "folgeStatusBezeichnung", "buttonBezeichnung",
            "buttonJeRaum", "positionInButtonListe"
            }; 
//  @formatter:on
    ...
    @Override
    public int insert(EclWortmeldetischFolgeStatus pEcl) {
        initFelder();
    ...
    /**Liest alle Demo-Kennungen ein*/
     public int readAll(int pSetNr) {
        ...
        try {
            ...
            lSql = lSql + "WHERE setNr=? ORDER BY positionInButtonListe;";
...
//     * 
//     */
//    public int update(EclWortmeldetischFolgeStatus pEcl) {
//        int ergebnis=0;
//        initFelder();
//
//        try {
