...
public class WEVersandAdresseKorrigieren {

    private WELoginVerify weLoginVerify = null;

    private EclWillenserklaerung willenserklaerung = null;
    private EclWillenserklaerungZusatz willenserklaerungZusatz = null;
