...
public class WEEintrittskarteStornierenGet {
   ...
   public String getAusgewaehlteHauptAktionString() {
    ...
    @Deprecated
    public void setAusgewaehlteHauptAktionString(String ausgewaehlteHauptAktionString) {
        this.ausgewaehlteHauptAktionString = ausgewaehlteHauptAktionString;
    }
