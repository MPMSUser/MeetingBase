...
public class WEPruefeLoginUserRC extends WERootRC {
    ...
    /**Eingeloggter User (ohne Passwort)*/
    public EclUserLogin eclUserLogin = null;

    /**Ausgewählter Mandant - falls vorhanden*/
    public EclEmittenten eclEmittenten = null;
