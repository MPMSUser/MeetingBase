...
/**
 * <p>Java-Klasse für NotificationType3Code.
 * 
...
public enum NotificationType3Code {
    ...
    public static String[] getLabels() {
        return new String[] { "New", "Replacement" };
    }

    public static String toLabel(NotificationType3Code v) {
        return switch (v) {
        case NEWM -> "New";
    ...
    public static NotificationType3Code fromLabel(String v) {
        return switch (v) {
        case "New" -> NEWM;
