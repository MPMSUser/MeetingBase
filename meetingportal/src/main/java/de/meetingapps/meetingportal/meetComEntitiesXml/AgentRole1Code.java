...
/**
 * <p>Java-Klasse für AgentRole1Code.
 * 
...
public enum AgentRole1Code {
    ...
    public static String[] getLabels() {
        return new String[] { "PrincipalAgent" };
    }

    public static String toLabel(AgentRole1Code v) {
        return switch (v) {
        case PRIN -> "PrincipalAgent";
        default -> throw new IllegalArgumentException("Unexpected value: " + v);
        };
    }

    public static AgentRole1Code fromLabel(String v) {
        return switch (v) {
        case "PrincipalAgent" -> PRIN;
        default -> throw new IllegalArgumentException("Unexpected value: " + v);
        };
    }
