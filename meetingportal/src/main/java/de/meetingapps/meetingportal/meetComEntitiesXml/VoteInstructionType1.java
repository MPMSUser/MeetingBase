...
/**
 * <p>Java-Klasse für VoteInstructionType1 complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="VoteInstrTpCd" type="{urn:iso:std:iso:20022:tech:xsd:seev.001.001.11}VoteInstructionType1Choice"/&gt;
 *         &lt;element name="AddtlInf" type="{urn:iso:std:iso:20022:tech:xsd:seev.001.001.11}Max350Text" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class VoteInstructionType1 {
    ...
    /**
     * Ruft den Wert der voteInstrTpCd-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der voteInstrTpCd-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link VoteInstructionType1Choice }
