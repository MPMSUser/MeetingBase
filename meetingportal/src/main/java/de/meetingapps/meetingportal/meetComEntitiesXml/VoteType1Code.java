...
/**
 * <p>Java-Klasse für VoteType1Code.
 * 
...
public enum VoteType1Code {
    ...
    public static String[] getLabels() {
        return new String[] { "Advisory", "Binding" };
    }

    public static String toLabel(VoteType1Code v) {
        return switch (v) {
        case ADVI -> "Advisory";
        case BNDG -> "Binding";
    ...
    public static VoteType1Code fromLabel(String v) {
        return switch (v) {
        case "Advisory" -> ADVI;
        case "Binding" -> BNDG;
        default -> throw new IllegalArgumentException("Unexpected value: " + v);
