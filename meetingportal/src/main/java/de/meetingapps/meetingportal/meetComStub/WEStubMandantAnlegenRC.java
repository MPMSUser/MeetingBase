...
public class WEStubMandantAnlegenRC extends WERootRC {
    ...
    public List<EclEmittenten> getEmittentenListe() {
        return emittentenListe;
    }

    public void setEmittentenListe(List<EclEmittenten> emittentenListe) {
        this.emittentenListe = emittentenListe;
    }

    public EclEmittenten[] getMandantenArray() {
        return mandantenArray;
    }

    public void setMandantenArray(EclEmittenten[] mandantenArray) {
        this.mandantenArray = mandantenArray;
    }
