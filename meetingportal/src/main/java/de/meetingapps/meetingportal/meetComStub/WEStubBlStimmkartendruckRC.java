...
public class WEStubBlStimmkartendruckRC extends WERootRC implements Serializable  {
    private static final long serialVersionUID = -5506903935181437968L;
    ...
    public  boolean stimmkartenUeberschriftenStehenZurVerfuegung=true;
