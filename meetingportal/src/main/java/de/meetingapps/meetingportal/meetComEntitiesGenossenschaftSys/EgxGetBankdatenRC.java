...
public class EgxGetBankdatenRC {

	public List<EgxGetBankdatenResult> result;
	...
	public List<EgxGetBankdatenResult> getResult() {
		return result;
	}
	public void setResult(List<EgxGetBankdatenResult> result) {
		this.result = result;
	}
