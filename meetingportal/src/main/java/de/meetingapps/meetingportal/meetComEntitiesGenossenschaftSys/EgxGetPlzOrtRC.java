...
public class EgxGetPlzOrtRC {

	public List<EgxGetPlzOrtResult> result;
	...
	public List<EgxGetPlzOrtResult> getResult() {
		return result;
	}
	public void setResult(List<EgxGetPlzOrtResult> result) {
		this.result = result;
	}
