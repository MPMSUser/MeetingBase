...
public class EgxGetLaenderRC {

	public List<EgxGetLaenderResult> result;
	...
	public List<EgxGetLaenderResult> getResult() {
		return result;
	}
	public void setResult(List<EgxGetLaenderResult> result) {
		this.result = result;
	}
