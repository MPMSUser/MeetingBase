...
public class EgxGetAdressenRC {

    public List<EgxGetAdressenResult> result;
    ...
    public List<EgxGetAdressenResult> getResult() {
        return result;
    }
    public void setResult(List<EgxGetAdressenResult> result) {
        this.result = result;
    }
