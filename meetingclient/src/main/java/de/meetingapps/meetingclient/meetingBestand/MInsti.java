...
public class MInsti {
    ...
    /**
     * Instantiates a new m insti.
     *
     * @param pInsti the insti
     */
    public MInsti(EclInsti pInsti) {
        this.ident = pInsti.ident;
        this.kurzBezeichnung = pInsti.kurzBezeichnung;
        this.standardSammelkarteGruppennummer = pInsti.standardSammelkarteGruppennummer;
        this.standardMeldeName = pInsti.standardMeldeName;
        this.standardMeldeOrt = pInsti.standardMeldeOrt;
        this.festadressenNummer = pInsti.festadressenNummer;
    }
    ...
    /**
     * Gets the kurz bezeichnung.
     *
     * @return the kurz bezeichnung
     */
    ...
    /**
     * Sets the kurz bezeichnung.
     *
     * @param kurzBezeichnung the new kurz bezeichnung
     */
    ...
    /**
     * Gets the standard sammelkarte gruppennummer.
     *
     * @return the standard sammelkarte gruppennummer
     */
    public int getStandardSammelkarteGruppennummer() {
        return standardSammelkarteGruppennummer;
    }

    /**
     * Sets the standard sammelkarte gruppennummer.
     *
     * @param standardSammelkarteGruppennummer the new standard sammelkarte
     *                                         gruppennummer
     */
    public void setStandardSammelkarteGruppennummer(int standardSammelkarteGruppennummer) {
        this.standardSammelkarteGruppennummer = standardSammelkarteGruppennummer;
    }

    /**
     * Gets the standard melde name.
     *
     * @return the standard melde name
     */
    public String getStandardMeldeName() {
        return standardMeldeName;
    }

    /**
     * Sets the standard melde name.
     *
     * @param standardMeldeName the new standard melde name
     */
    public void setStandardMeldeName(String standardMeldeName) {
        this.standardMeldeName = standardMeldeName;
    }

    /**
     * Gets the standard melde ort.
     *
     * @return the standard melde ort
     */
    public String getStandardMeldeOrt() {
        return standardMeldeOrt;
    }

    /**
     * Sets the standard melde ort.
     *
     * @param standardMeldeOrt the new standard melde ort
     */
    public void setStandardMeldeOrt(String standardMeldeOrt) {
        this.standardMeldeOrt = standardMeldeOrt;
    }

    /**
     * Gets the festadressen nummer.
     *
     * @return the festadressen nummer
     */
    public int getFestadressenNummer() {
        return festadressenNummer;
    }

    /**
     * Sets the festadressen nummer.
     *
     * @param festadressenNummer the new festadressen nummer
     */
    public void setFestadressenNummer(int festadressenNummer) {
        this.festadressenNummer = festadressenNummer;
    }

    /**
     * Gets the zutritts ident aktuell.
     *
     * @return the zutritts ident aktuell
     */
    public String getZutrittsIdentAktuell() {
        return zutrittsIdentAktuell;
    }

    /**
     * Sets the zutritts ident aktuell.
     *
     * @param zutrittsIdentAktuell the new zutritts ident aktuell
     */
    public void setZutrittsIdentAktuell(String zutrittsIdentAktuell) {
        this.zutrittsIdentAktuell = zutrittsIdentAktuell;
    }

    /**
     * Gets the stimmkarte aktuell.
     *
     * @return the stimmkarte aktuell
     */
    public String getStimmkarteAktuell() {
        return stimmkarteAktuell;
    }

    /**
     * Sets the stimmkarte aktuell.
     *
     * @param stimmkarteAktuell the new stimmkarte aktuell
     */
    public void setStimmkarteAktuell(String stimmkarteAktuell) {
        this.stimmkarteAktuell = stimmkarteAktuell;
    }
     ...
     * Sets the sonstiges.
     *
     * @param sonstiges the new sonstiges
     */
