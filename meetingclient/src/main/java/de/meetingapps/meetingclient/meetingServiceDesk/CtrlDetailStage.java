...
public class CtrlDetailStage extends CtrlRoot {
    ...
    void initialize() {
        ...
        assert btnFertigStandard != null
                : "fx:id=\"btnFertigStandard\" was not injected: check your FXML file 'DetailStage.fxml'.";
        ...
        assert scpnStandard != null
                : "fx:id=\"scpnStandard\" was not injected: check your FXML file 'DetailStage.fxml'.";
        assert tbDetail != null : "fx:id=\"tbDetail\" was not injected: check your FXML file 'DetailStage.fxml'.";
        assert btnFertigDetail != null
                : "fx:id=\"btnFertigDetail\" was not injected: check your FXML file 'DetailStage.fxml'.";
