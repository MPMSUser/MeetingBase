...
/**
 * The Class CtrlZeige3Buttons.
 */
public class CtrlZeige3Buttons {
    ...
    /** The btn weiter. */
    @FXML
    private Button btnAbbruchAlternativ;
    ...
    /** The text weiter. */
    public String textAbbruchAlternativ = "AbbruchAlternativ";



    /** true => Weiter geklickt; false=Abbruch geklickt". */
    public boolean ergebnis = true;
    public boolean ergebnisAlternativ=false;
    /**
     * Initialize.
     */
    @FXML
    void initialize() {
        ...
        btnAbbruchAlternativ.setText(textAbbruchAlternativ);
        btnAbbruchAlternativ.requestFocus();
    }
    ...
    @FXML
    void onBtnAbbruchAlternativ(ActionEvent event) {
        ergebnis = false;
        ergebnisAlternativ=true;
        eigeneStage.hide();
    }
